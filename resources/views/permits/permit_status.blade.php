                                ...
                                <div class="card-header">
                                    <div class="row">
                                        <div class="col-md-1">
                                            ...
                                            <h4 class="card-title mb-0 pt-3">Permit Status</h4>
                                        </div>
                                        <div class="col-md-6">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <!-- <h5 class="modal-title" id="myModalLabel">Create Permit Status</h5> -->
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="mb-3 row">
                                ...
                                <div class="col-md-10">
                                    <input class="form-control" type="text" placeholder="Enter Permit Status Title"
                        ...
                        <div class="col-12">
                            <div class="mb-3 row">
                                ...
                                <div class="col-md-10">
                                    <input class="form-control" type="color" placeholder="Enter SLA" id="s_color"
                                        name="s_color">
                                </div>
                            </div>
                        </div>
    ...
    $.ajax(settings).done(function(response) {
        ...
        $.each(response, function(index, data) {
            ...
            table.row.add([
                ...
                data.status,
                // data.color,
                '<div class="circle" id="status_'+data.id+'"></div>',
            ...
            $('#status_'+data.id+'').css("background-color", color);
        });
    });
}
...
function submit() {
    ...
    if (update_id == 0) {
        ...
        form.append("s_name", $('#s_name').val());
        form.append("s_color", $('#s_color').val());
