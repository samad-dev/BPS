                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="mb-3 row">
                                ...
                                <div class="col-md-10">
                                    <input class="form-control" type="text" placeholder="Enter Permit Status Title" id="example-text-input">
                                </div>
                            </div>
                        </div>
                        <div class="col-12">
                            <div class="mb-3 row">
                                ...
                                <div class="col-md-10">
                                    <input class="form-control" type="color" placeholder="Enter SLA" id="sla">
                                </div>
                            </div>
                        </div>
                        <div class="col-12">
