...
<head>
    ...
    <meta charset="utf-8" />
    <title>Assign users to team | BPS</title>
...
<body data-layout-mode="bordered" data-topbar="dark" data-sidebar="dark">
                                ...
                                <div class="card-header">
                                    <div class="row">
                                        <div class="col-md-2">
                                            ...
                                            <h4 class="card-title mb-0 pt-3">Assign users to team</h4>
                                        </div>
                                        <div class="col-md-6">
    ...
    <div class="offcanvas offcanvas-end w-25" tabindex="-1" id="offcanvasRight" aria-labelledby="offcanvasRightLabel">
        <div class="offcanvas-header">
            <h5 id="offcanvasRightLabel">Create Assign users to team</h5>
        ...
        <div class="offcanvas-body" id="fetchres">
            <div class="row">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="mb-3">
                            <label for="formrow-firstname" class="form-label"> Team</label>
                    ...
                    <div class="col-lg-12">
                        <div class="mb-3">
                            <label for="formrow-firstname" class="form-label">Users</label>
                            <!-- <input type="text" class="form-control" id="name" name='name'> -->
                            <select class="form-control select_" name="choices-single-default" id="applicant"
                                name='applicant' placeholder="This is a search placeholder" multiple>
