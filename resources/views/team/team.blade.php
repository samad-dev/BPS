                                ...
                                <div class="card-header">
                                    <div class="row">
                                        <div class="col-md-1">
                                            ...
                                            <h4 class="card-title mb-0 pt-3">Team</h4>
                                        </div>
                                        <div class="col-md-6">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <!-- <h5 class="modal-title" id="myModalLabel">Create Team</h5> -->
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-12">
                            ...
                            <div class="col-lg-12">
                                <div class="mb-3">
                                    <label for="formrow-firstname" class="form-label"> Team Name</label>
                                    <!-- <input type="text" class="form-control" id="name" name='name'> -->
                                    <input class="form-control" type="text" placeholder="Enter Team Title"
                                        id="example-text-input">
                                </div>
                            </div>
                            <div class="col-lg-12">
                                <div class="mb-3">
                                    <label for="formrow-firstname" class="form-label"> Lead</label>
                                    <!-- <input type="text" class="form-control" id="name" name='name'> -->
                                    <select class="form-control select_" name="choices-single-default" id="lead"
                                        name='lead' placeholder="This is a search placeholder">
