                        ...
                        <div class="col-md-8 col-lg-6 col-xl-5">
                            ...
                            <div class="mb-4 pb-2">
                                <a href="index.html" class="d-block auth-logo">
                                    <img src="https://seeklogo.com/images/C/coat-of-arms-of-ghana-logo-B921256FFD-seeklogo.com.png"
                                        alt="" height="80" class="auth-logo-dark me-start">
                                    <img src="https://seeklogo.com/images/C/coat-of-arms-of-ghana-logo-B921256FFD-seeklogo.com.png"
                                        alt="" height="80" class="auth-logo-light me-start">
                                </a>
                            </div>
                            ...
                            <div class="card">
                                <div class="card-body p-4">
                                    <div class="text-center mt-2">
                                        <h5>Welcome Back !</h5>
                                        <p class="text-muted">Sign in to continue to BPS.</p>
                                    </div>
                                    @if ($errors->any())
                        ...
                        <div class="col-lg-12">
                            <div class="text-center p-4">
                                <p>©
                                    ...
                                    </script> BPS. Crafted with <i class="mdi mdi-heart text-danger"></i> by <a
