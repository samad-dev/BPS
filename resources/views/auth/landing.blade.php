...
<head>
    ...
    <!-- FAVICON FILES -->
    <link href="landing/assets/images/icons/apple-touch-icon-144-precomposed.png" rel="apple-touch-icon" sizes="144x144">
    <link href="landing/assets/images/icons/apple-touch-icon-120-precomposed.png" rel="apple-touch-icon" sizes="120x120">
                ...
                <div class="dtr-box-wrapper-round dtr-bg-shapes-type-1 bg-white">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-md-6 dtr-py-100 dtr-sm-p-50 dtr-px-100">
                            ...
                            <!-- button 1 -->
                            <a href="/login" class="dtr-btn dtr-btn-right-icon dtr-mt-30 dtr-mr-5 btn-dark-blue">Login<span class="btn-span bg-blue color-white"><i
                                        class="icon-arrow-right"></i></span></a>
                            <!-- button 2 -->
                            <a href="#modalMultiStep" class="dtr-btn dtr-btn-right-icon dtr-mt-30 btn-blue trigger"
                                data-backdrop="static" data-keyboard="false" data-toggle="modal">Get In Touch<span
                                                                    ...
                                                                    <div class="form-group">
                                                                        <div class="custom-file">
                                                                            ...
                                                                            <label for="" class="form-label"> Property
                                                                                Description</label>
                                                                            <textarea class="form-control wizzy" name="property_description"
                        ...
                        function submit() {
                            ...
                            if (emptyFields.length === 0) {
                                ...
                                if (update_id == 0) {
                                    ...
                                    var settings = {
                                        "url": "http://151.106.17.246:8000/api/building_permits",
                                        "method": "POST",
                                        "timeout": 0,
                                        "processData": false,
