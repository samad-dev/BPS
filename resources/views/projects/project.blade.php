...
<body data-layout-mode="bordered" data-topbar="dark" data-sidebar="dark">
    ...
    <div class="offcanvas offcanvas-end w-50" tabindex="-1" id="offcanvasRight" aria-labelledby="offcanvasRightLabel">
        <div class="offcanvas-header">
            <h5 id="offcanvasRightLabel">Create Properties</h5>
        ...
        <div class="offcanvas-body" id="fetchres">
            <div class="row">
                ...
                <div class="row">
                    <div class="col-lg-4">
                        <div class="mb-3">
                            <label for="formrow-firstname" class="form-label"> Name</label>
                            <input type="text" class="form-control" id="name" name='name'>
                        </div>
                    </div>
                    <div class="col-lg-4">
                        <div class="mb-3">
                            <label for="formrow-email" class="form-label"> Start Date</label>
                    ...
                    <div class="col-lg-4">
                        <div class="mb-3">
                            <label for="formrow-email" class="form-label"> End Date</label>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4">
                        <div class="mb-3">
                            <label for="formrow-inputCity" class="form-label">Estimated Cost</label>
                    ...
                    <div class="col-lg-4">
                        <div class="mb-3">
                            <label for="formrow-inputZip" class="form-label">Location</label>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div id="map-canvas" style="width: 100%; height: 30vh; z-index: 0;" class="">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="mb-3">
                            <label for="formrow-State" class="form-label">Property Description</label>
